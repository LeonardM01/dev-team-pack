...
- Read your agent memory for this project first; it holds the doc conventions and file locations earlier runs found.
- When you finish, tick the docs item on the checklist in `PROGRESS.md` (`- [ ] D. Docs` to `- [x]`). That tick and your report are how the architect knows the work is done; do not tick anything else.
